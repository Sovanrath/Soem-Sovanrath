  ...
  return (
    ...
    >
      <div className="md:w-1/2">
        ...
        <div className="flex items-center w-full justify-center gap-5 p-5">
          {Contact.map((item, index) => (
            ...
            >
              <Link target="_blank" href={item.link}>
                {item.icon && (
                  <item.icon className="hover:-translate-y-3 duration-300 size-20 p-5 rounded-2xl stroke-1 hover:shadow-[0_10px_30px_rgba(0,0,0,0.3)] dark:hover:shadow-[0_10px_30px_rgba(0,183,235,0.3)]" />
                )}
              </Link>
            </Motion>
          ))}
